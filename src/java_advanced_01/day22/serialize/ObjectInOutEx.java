...
//자바는 메조리에 생성된 객체를 파일 또는 네트워크로 출력할 수 있다.
...
class User implements Serializable {
    ...
    public static int count = 0; //static 필드도 직렬화 대상에서 제외한다.
}
...
public class ObjectInOutEx {
    public static void main(String[] args) throws Exception {
        //1. C:/Temp/object.dat 에 파일객체에 파일입력 객체를 생성해 주세요
        String fileName = "C:/Temp/object.dat";
        FileOutputStream fos = new FileOutputStream(fileName);

        //2. 생성된 파일입력스트림 객체에 객체출력스트림 객체를 끼워주세요
