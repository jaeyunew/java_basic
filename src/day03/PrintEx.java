...
public class PrintEx {
    public static void main(String[] args) {
        ...
        System.out.printf("과목명: %2$s 이름: %1$s\n", "김재윤", "자바");
        System.out.printf("과목명: %2$s 이름: %1$s 학번: %3$s\n", "김재윤", "자바", "12341");

        //정수 123을 printf()를 이용해 출력

        System.out.printf("%d\n", 123);

        //정수 ___123을 printf() 사용 6자리 정수 출력, 왼쪽 빈자리 공백

        System.out.printf("%6d \n", 123);

        //정수 ___123을 printf() 사용 6자리 정수 출력, 오른쪽 빈자리 공백
        System.out.printf("%-6d \n", 123);

        //정수 000123을 printf() 사용 6자리 정수 출력, 오른쪽 빈자리 0으로 채우기
